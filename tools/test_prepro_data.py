...
python test_prepro_data.py \
      --input /home/kit/stud/ukmwn/master_thesis/data/training_ready/ready4token/sample_trial_run_data.jsonl \
      --output-prefix sc_test \
      --vocab-file /home/kit/stud/ukmwn/master_thesis/data/tokenizer/gpt2/gpt2-vocab.json \
      --merge-file /home/kit/stud/ukmwn/master_thesis/data/tokenizer/gpt2/gpt2-merges.txt \
      --tokenizer-type GPT2BPETokenizer \
      --append-eod  --workers 1 \
      --mask_type v3_all_after_half
